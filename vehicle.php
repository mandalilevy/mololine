...
<ul class="navbar-nav  mt-lg-0 ml-auto-auto">
 ...
 <ul class="navbar-nav  mt-lg-0 ml-auto">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: bolder;" class="nav-link" href="vehicle.php">Add Vehicle</a>
      </li>
       <li class="nav-item">
            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                      <div class="card-body">
                        <h3 class="text-center text-info"> <u> New Vehicle </u></h3>
...
<?php 
               ...
               ?>
                        ...
                        <form id="login-form" class="form" action="adv.php" method="post">
