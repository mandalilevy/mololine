                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="" method="post">
                            <h3 class="text-center text-info">Passanger Login</h3>
                            ...
                            <div id="register-link" class="text-right">
                                <a href="preg.php" class="text-info">Register Here</a>
                            </div>
                        </form>
                    </div>
                </div>
...
$query ="SELECT * FROM `passanger`  WHERE id='".$_POST['username']."' AND pass='".$_POST['password']."'";
$result=mysqli_query($con,$query);
if (mysqli_fetch_assoc($result)) {
   $_SESSION['passanger']=$_POST['username'];
