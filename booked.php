...
if (isset($_SESSION['passanger'])) {
 ...
 <ul class="navbar-nav  mt-lg-0 mx-auto">
     <li class="nav-item">
        <a style="color: white; font-family:Verdana; cursor: pointer; font-weight: bolder;" class="nav-link" href="passanger.php">Fair Chart</a>
      </li>
    <li class="nav-item">
...
<tr><td style="width: auto;"><?php echo $row["date"]; ?></td>
